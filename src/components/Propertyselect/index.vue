<template>
    <div>
        <el-select placeholder="请选择产品分类" :disabled="addvalue==0?false:true" v-model="value" style="margin: 10px auto" @change="getplatformattribute">
      <el-option v-for="item in AttrStore.propertyList.data" :label="item.name" :key="item.id"
