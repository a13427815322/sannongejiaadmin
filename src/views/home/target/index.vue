<template>
  <div style="flex:1">
    <el-card shadow="always" style="width:100%; height:400px;margin-top: 20px;">
      ...
      <div style="display: flex;width: 100%;justify-content: center;margin: 10px 0;">
        <div v-for="item in '4396'" style="width: 50px;height: 50px;line-height: 50px;text-align: center;font-size: 40px;color: #099;opacity: 0.5;" >{{item}}</div>
      </div>
